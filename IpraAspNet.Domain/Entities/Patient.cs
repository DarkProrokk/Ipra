...
public class Patient
{
    ...
    [StringLength(50)] public string Surname { get; set; } = null!;
    ...
    [StringLength(14)] public string? Snils { get; set; }

    [StringLength(16)] public string? ENP { get; set; }
    ...
    [InverseProperty("Patient")] public virtual ICollection<Files> Files { get; set; } = new List<Files>();

    [InverseProperty("Patient")] public virtual ICollection<Ipra> Ipras { get; set; } = new List<Ipra>();
