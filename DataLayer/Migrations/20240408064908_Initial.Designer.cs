...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240408064908_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.AddressType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Buro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Citizenship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.District", b =>
                {
                    b.Property<int?>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.DocType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.DysfunctionsDegree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.EventSubtype", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.EventType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Executor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Files", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.FuncCompensation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.FuncRecovery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.GroupsTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.HelpCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Ipra", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.IpraHelpCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.IpraMovesHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.IpraStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.MO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Move", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.PrognozResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.RecipientType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.RehabPotential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.RehabPrognoz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Result", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Tasks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.UserMO", b =>
                {
            ...
            modelBuilder.Entity("DataLayer.Entities.EventSubtype", b =>
                {
                    b.HasOne("DataLayer.Entities.EventType", "Type")
            ...
            modelBuilder.Entity("DataLayer.Entities.Ipra", b =>
                {
                    b.HasOne("DataLayer.Entities.Buro", "Buro")
                        .WithMany("Ipras")
                        .HasForeignKey("BuroId")
                        .IsRequired()
                        .HasConstraintName("fk_Buro");

                    b.HasOne("DataLayer.Entities.Citizenship", "Citizenship")
                        .WithMany("Ipras")
                    ...
                    b.HasOne("DataLayer.Entities.PrognozResult", "PR")
                        .WithMany("Ipras")
                        .HasForeignKey("PRId")
                    ...
                    b.HasOne("DataLayer.Entities.DocType", "RepresentativeIdentDocTypeNavigation")
                    ...
                    b.HasOne("DataLayer.Entities.MO", "SenderMo")
                        .WithMany("IpraSenderMos")
                        .HasForeignKey("SenderMoId")
                        .HasConstraintName("fk_IpraSenderMo");

                    b.HasOne("DataLayer.Entities.IpraStatus", "Status")
                        .WithMany("Ipras")
            ...
            modelBuilder.Entity("DataLayer.Entities.IpraHelpCategory", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.HelpCategory", "HelpCategory")
                        .WithMany("IpraHelpCategories")
                        .HasForeignKey("HelpCategoryId")
                        .IsRequired()
                        .HasConstraintName("fk_HelpCategory");

                    b.HasOne("DataLayer.Entities.Ipra", "Ipra")
                        .WithMany("IpraHelpCategories")
            ...
            modelBuilder.Entity("DataLayer.Entities.IpraMovesHistory", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.Move", "Move")
                        .WithMany("IpraMovesHistories")
            ...
            modelBuilder.Entity("DataLayer.Entities.Report", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.EventSubtype", "EventSubtype")
                        .WithMany("Reports")
                        .HasForeignKey("EventSubtypeId")
                        .HasConstraintName("FK_Reports_EventSubtype");

                    b.HasOne("DataLayer.Entities.EventType", "EventType")
                        .WithMany("Reports")
                        .HasForeignKey("EventTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_Reports_EventType");

                    b.HasOne("DataLayer.Entities.Executor", "Executor")
                        .WithMany("Reports")
                    ...
                    b.HasOne("DataLayer.Entities.Result", "Result")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("DataLayer.Entities.Tasks", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.GroupsTask", "GroupTask")
                        .WithMany("Tasks")
